...
export const CenterBlock = ({ setLikedTracks, likedTracks }: CenterBlockProps) => {
    ...
    return (
        <div className={styles.mainCenterblock}>
            ...
            <Filter selectedFilter={filter} selectedFilterValue={filterValue} tracks={tracks} onSelect={onSelect} />
            <Playlist tracks={copy} setLikedTracks={setLikedTracks} likedTracksIds={likedTracks} />
        </div>
    )
}
