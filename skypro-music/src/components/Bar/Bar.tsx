...
import { setIsShuffleTrack, setNextTrack, setPrevTrack } from "@/store/features/trackSlice"
...
export const Bar = ({ currentTrack, likedTracksIds: likedTracks, isLiked, onLikeToggle }: props) => {
    // const isLiked = Array.isArray(likedTracks)
    //     ? new Set(likedTracks.map((x) => x._id)).has(currentTrack._id)
    //     : likedTracks.has(currentTrack._id)
